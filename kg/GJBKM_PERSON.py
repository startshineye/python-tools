...
def construct_data(id, person_name, person_position):
    data_template['entity_id'] = id
    data_template['entity_name'] = person_name
    data_template['props']['GJBKM_PERSON']['person_name'] = person_name
    data_template['props']['GJBKM_PERSON']['person_position'] = person_position
...
def import_excel(excel):
    for rown in range(excel.nrows):
        ...
        e = sheets_.cell_value(rown, 1)
        array = {'id': int(sheets_.cell_value(rown, 0)), 'person_name': sheets_.cell_value(rown, 1), 'person_position': sheets_.cell_value(rown, 2)}
        tables.append(array)
