...
def construct_data(id, time):
    data_template['entity_id'] = id
    data_template['entity_name'] = time
    data_template['props']['GJBKM_TIME']['time'] = time
...
def import_excel(excel):
    for rown in range(excel.nrows):
        ...
        array = {'id': int(sheets_.cell_value(rown, 0)), 'time': e}
        tables.append(array)
