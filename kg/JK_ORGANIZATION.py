...
data_template = {
    ...
    "entity_id": "",
    "entity_name": "",
    "entity_type": "GJBKM_ORGANIZATION",
...
def construct_data(id, organization_name):
    data_template['entity_id'] = id
    data_template['entity_name'] = organization_name
    data_template['props']['GJBKM_ORGANIZATION']['organization_name'] = organization_name
...
def import_excel(excel):
    for rown in range(excel.nrows):
        ...
        if rown == 0:
            continue
        array = {'id': int(sheets_.cell_value(rown, 0)), 'organization_name': sheets_.cell_value(rown, 1)}
        tables.append(array)
...
if __name__ == '__main__':
    ...
    for i in tables:
        ...
        try:
           # print(i)
           # print(i['standard_no'])
            data = construct_data(i['id'], i['organization_name'])
